...
export default function EditLinkDialog({ isOpen, onClose, linkData, onSave }) {
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} ref={dialogRef} size="xl">
      <div className="max-w-full max-h-[sm] relative flex flex-col">
        ...
        <div
          className="w-full my-6 grid grid-cols-1 md:grid-cols-2 gap-2 h-80 pb-24 overflow-auto
      ...
      "
        ...
        <div className="w-full flex items-center gap-2 absolute bottom-0 bg-navy py-6">
          <Button
